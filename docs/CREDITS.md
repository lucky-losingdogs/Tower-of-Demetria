...
- The tile-based crop growth cycles are based off of [sikozonpc's mechanic](https://github.com/sikozonpc/Tile-Based-Crop-Growing-Mechanics).
...
- [Effect Pack All](https://bdragon1727.itch.io/retro-impact-effect-pack-all).

- [Superpowers Asset Pack](https://sparklinlabs.itch.io/superpowers).

- [Farming Crops Sprites](https://opengameart.org/content/farming-crops-16x16).

- [Pixel Farming Tools](https://thurraya.itch.io/pixel-farming-tools-icon-set-16x16-32x32).
...
- [Battle in the Stratosphere](https://opengameart.org/content/battle-in-the-stratosphere).

- [Game Over Theme](https://opengameart.org/content/game-over-theme).

- [Store Entrance Bell](https://pixabay.com/sound-effects/film-special-effects-store-entrance-bell-188054/).
